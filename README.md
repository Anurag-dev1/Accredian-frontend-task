...
1. **Clone the repository**
    ```bash
    git clone https://github.com/Anurag-dev1/AccredianFrontend.git ↩
...
- Author: Anurag Verma
- Email: anurag1246verma2121@gmail.com
- GitHub: https://github.com/Anurag-dev1/

### Notes:

1. **Repository URL**: Make sure to update the repository URL (`https://github.com/Anurag-dev1/AccredianFrontend.git`) with the actual URL of your frontend repository.
